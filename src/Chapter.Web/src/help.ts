...
const SHORTCUTS: [keys: string, what: string][] = [
  ...
  ['<kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>O</kbd>', 'Clone a repository'],
  ['<kbd>Ctrl</kbd> <kbd>O</kbd>', 'Add a repository already on disk'],
  ['<kbd>Tab</kbd> (refs panel)', 'Next section, through to remotes and pull requests'],
  ['<kbd>→</kbd> <kbd>←</kbd> (refs panel)', "The selected row's actions, then the buttons below"],
  ['<kbd>A</kbd> (Worktrees)', 'Accept the selected agent worktree into main'],
  ['<kbd>R</kbd> (Worktrees)', 'Reject and reset the selected agent worktree'],
  ['<kbd>[</kbd> / <kbd>]</kbd>', 'Batch review: previous / next usable worktree'],
  ['<kbd>Ctrl</kbd> <kbd>Alt</kbd> <kbd>M</kbd>', 'Mark the current worktree reviewed'],
  ['<kbd>Ctrl</kbd> <kbd>H</kbd>', 'Commit history'],
  ['<kbd>Ctrl</kbd> <kbd>F</kbd>', 'Search history when the timeline is open'],
  ['<kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>H</kbd>', 'History for the open file'],
  ['<kbd>C</kbd> / <kbd>R</kbd>', 'In history: cherry-pick / revert the selected commit'],
  ['<kbd>Ctrl</kbd> <kbd>Alt</kbd> <kbd>B</kbd>', 'Toggle line blame in Code mode'],
  ['<kbd>Ctrl</kbd> <kbd>D</kbd>', 'Diff or code'],
  ['<kbd>Ctrl</kbd> <kbd>\\</kbd>', 'Inline or side-by-side diff'],
  ['<kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>E</kbd>', 'Open this file in Rider or VS Code'],
